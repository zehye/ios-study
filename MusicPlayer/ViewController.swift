...
//  MusicPlayer
//
//  Created by 졔님 on 2020. 1. 20..
//  Copyright © 2020년 zehye. All rights reserved.
//
...
class ViewController: UIViewController, AVAudioPlayerDelegate {
    ...
    func initializePlayer() {  // 플레이어를 초기화 하는 메서드
    ...
    func updateTimeLabelText(time: TimeInterval) {  // 레이블을 매초마다 업데이트해주는 메서드
    ...
    func makeAndFireTimer() {  // 타이머를 만들고 수행해줄 메서드
    ...
    func invalidateTimer() {  // 타이머를 해제해줄 메서드
